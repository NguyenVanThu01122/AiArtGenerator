...
const PromptInput: React.FC<PromptInputProps> = ({ prompt, setPrompt, negativePrompt, setNegativePrompt }) => {
  ...
  return (
    <Wrapper>
      <BoxPrompt>
        ...
        <ContentPrompt>
          {t('Describe whatever you want or directly click the Suggestion icon to quickly generate AI art.')}
        </ContentPrompt>
