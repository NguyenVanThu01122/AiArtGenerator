...
import { fetchPricing } from '../../redux/Thunks/GetPricing/fetchPricing'
...
function Pricing() {
  ...
  const { listPricing } = useSelector((state: RootState) => state.getListPricingSlice)
  ...
  return (
    <WrapperPricing>
      <BoxContent>
        <PricingOptions listPricing={listPricing} selectPrice={selectPrice} handleStripeOrder={handleStripeOrder} />
        <CreatorHubSection />
