...
export const StyledGridHead = styled(Grid)(({ theme }) => ({
  ...
  "& .title": {
    ...
    "& > div:last-child": {
      ...
      lineHeight: "120%",
      "& .empty": {
        boxShadow: "0px 8px 180px 50px rgb(129, 140, 248)",
      },
      "& span": {
...
export const StyledCard = styled(Card)(
  ({ theme, textToImage }: { theme: Theme; textToImage: boolean }) => ({
    ...
    background:
      "linear-gradient(rgba(8, 7, 23, 0) 43.92%, rgb(8, 7, 23) 94.74%)",
...
export const BoxTextVideo = styled(Box)(
  ({ textToImage }: { textToImage: boolean }) => ({
    display: "flex",
    justifyContent: "space-between",
    alignItems: "end",
    padding: "15px",
...
export const ContentTextVideo = styled("div")(
  ({ textToImage }: { textToImage: boolean }) => ({
    width: "70%",
    "& > div:first-child": {
      color: "rgb(255, 255, 255)",
...
export const BoxTexToImage = styled(Box)(
  ({ theme, textToImage }: { textToImage: any; theme: Theme }) => ({
    height: "100%",
    width: textToImage ? "70%" : "30%",
    position: "relative",
    backgroundImage:
...
export const TexToImage = styled("div")(
  ({ textToImage }: { textToImage: any }) => ({
    width: "100%",
    height: "100%",
    display: "flex",
    alignItems: "end",
