...
function Home() {
  ...
  const handleNotification = () => toast.success(t(NOTIFICATION))
      ...
      <BoxContent>
        ...
        <ItemCarousel slidesToShow={1} dots={true} autoplay>
          <div className='introduce-item'>
            <div className='contents'>
              ...
              <div>
                {t('We empower content creators like you to unleash their full creative potential.')}
                {t(
          ...
          <div className='introduce-item'>
            <div className='contents'>
              ...
              <div>
                {t('Use code')} <span style={{ margin: '0px 5px' }}>EARLY100</span>
                {t(
              ...
              {listProduct.map((item: ListProductType) => (
                <div className='detail-product' key={item?.id}>
                  ...
                  <ButtonGeneral
                    ...
                    onClick={() => (item?.url ? navigate(item?.url) : handleNotification())}
                  >
                    <span>{t('Try Now')}</span>
        ...
        <LastItem>
          <div className='header'>
            ...
            <ButtonGeneral onClick={() => navigate(ROUTES.AI_ART_GENERATOR)}>{t('Get Started')}</ButtonGeneral>
          </div>
        </LastItem>
      </BoxContent>
      <Footer />
